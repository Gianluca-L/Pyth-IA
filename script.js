...
const forza_animo_fallimento_keywords = ['successo', 'success', 'insuccess', 'vittoria', 'vittorie', 'vittorios', 'vincere', 'vinc', 'vinto', 'vinto', 'vint', 'risultat', 'fortun', 'ascesa', 'ascend', 'ascen', 'conquist', 'vetta', 'vette', 'riusci', 'raggiun', 'arriv',
        ...
        'fatale', 'mortal', 'inevitabil', 'licenziat', 'licenziar', 'licenziament'];
//////////////////////////////////////////////// ISPIRAZIONE

const ispirazione_generico_keywords = ['ispirazion', 'ispir', 'progett', 'progettar', 'progettist', 'design', 'designer', 'prototipar', 'user experience', 'experience', 'utent', 'digital', 'service design', 'prodott', 'servizi', 'creativ', 'creativit', 'crear', 'creer', 'creav', 'creazion', 'oper', 'manufatt', 'divin', 'estro', 'fervor', 'inspiraz', 'inspirar', 'inspirat', 'inspirarsi', 'capac', 'incapac', 'capacit', 'incapacità', 'maestria', 'abilità', 'abil', 'abilmente', 'brav', 'bravura', 'male', 'pessimamente', 'ottimamente', 'con successo', 'perfettamente', 'alla perfezione', 'a meraviglia', 'con i piedi', 'virtù', 'talento', 'talentuos', 'inett', 'inettitud', 'mediocrità', 'mediocr', 'astuzi', 'astut', 'stratagemm', 'mezzo', 'modo', 'sistema', 'espedient', 'trucco', 'artifici'];
...
const scienza_ispirazione_keywords = ['scienz', 'scienziat','laborator', 'spazi', 'spazial', 'stell', 'costellazion', 'galassi', 'laboratori', 'esperimento scientifico', 'esperimenti scientifici', 'fenomeni naturali', 'fenomeno naturale', 'chimic', 'biolog', 'alchimi', 'astrofisic', 'fisica', 'geolog', 'navicell', 'aerospazi', 'astronav', 'astronaut', 'astronomo'];
...
const morte_generico_keywords = ['che impressione si ha', 'morte', 'morire', 'mort', 'mortale', 'morente', 'muoio', 'muori', 'muor', 'moriv','moriamo', 'morite', 'muoiono', 'morendo', 'dipartit', 'perdit', 'scompars', 'trapass', 'mortalmente', 'croll', 'estinz', 'estinz', 'scompars', 'declin', 'tramont', 'defunt', 'decedere', 'decess', 'decedut', 'deced', 'sentir', 'sent', 'sensaz', 'provar', 'prov', 'sentiment', 'emoz', 'percez', 'percepisc', 'percepir', 'percepiv', 'morent', 'spirare', 'spirato', 'ultimo respiro', 'rendere l\'anima a dio', 'reso l\'anima a dio', 'svanire', 'svanisce', 'svanirà', 'accezione', 'contenuto', 'interess', 'impression', 'effett', 'testament'];
...
const aldilà_keywords = ['dopo la morte', 'dopo che muoio', 'dopo che sarò mort', 'dopo che saremo morti', 'dopo che sono morto', 'sarò morto', 'sarò morta', 'saremo morti', 'saremo morte', 'aldilà', 'paradiso', 'inferno', 'purgatorio', 'purificazione', 'purificarsi', 'purific', 'purificat', 'reincarnazion', 'reincarnarsi', 'reincarn', 'altro mondo', 'oltretomba', 'acheronte', 'Ade', 'inferi', 'esist', 'regno dei morti', 'spirit', 'tra la vita e la morte', 'stasi', 'anima', 'ermafrodit',
'mondo delle idee', 'mondo platonic', 'limbo'];

//////// PERCHE' DOBBIAMO MORIRE

const dobbiamo_morire_keywords = ['perché morire', 'perché moriamo', 'dobbiamo morire', 'dovremo morire', 'devo morire', 'perché si muore', 'che senso ha morire',  'bisogna morire', 'perché dovrò morire', 'perché ci spegniamo', 'perché tutto finisce', 'perché tutto ha una fine', 'perché la vita ha un termine', 'perché la vita finisce', 'perché la vita ha una fine', 'che significa morire', 'si deve morire', 'per quale ragione moriamo', 'per quale motivo moriamo', 'con quale scopo moriamo',
'per quale ragione si muore', 'per quale motivo si muore', 'per quale scopo morirò', 'dovremo morire', 'per quale scopo moriremo', 'dover morire', 'dovrò morire', 'bisognerà che moriamo', 'bisognerà che muoio', 'bisognerà morire', 'senso della morte', 'significato della morte', 'senso del morire', 'significato del morire', 'senso ha la morte', 'senso possiede la morte', 'senso dare alla morte', 'senso alla morte', 'significato alla morte', 'senso al morire', 'significato al morire',
'che vuol dire morire'];

const scopo_generico_keywords = ['scopo', 'fine ultimo', 'finale', 'senso', 'significat', 'sens', 'insens', 'signific', 'importanza', 'important', 'valor', 'valenz', 'illogic', 'incoerent', 'incoerenz', 'incongruent', 'incongruenz', 'insensat', 'irragionevol', 'irrazional', 'sconness', 'senza capo né coda', 'assurd', 'dissennat', 'sconsiderat', 'logic', 'ragionevol', 'razional', 'sensat', 'mistero', 'misteri', 'miracol', 'risolv', 'senso', 'signif', 'illogic', 'incoerent', 'incoerenz', 'incongruent', 'incongruenz', 'insensat', 'irragionevol', 'irrazional', 'sconness', 'senza capo né coda', 'assurd', 'dissennat', 'sconsiderat', 'logic', 'ragionevol', 'razional', 'sensat', 'peso', 'portata', 'rilevanza', 'rilevant', 'rilievo', 'spessore', 'valenza', 'valore', 'valer'];

const scopo_morte_keywords = ['morte', 'morire', 'mort', 'mortale', 'morente', 'muoio', 'muori', 'muor', 'moriv','moriamo', 'morite', 'muoiono', 'morendo', 'dipartit', 'perdit', 'scompars', 'trapass', 'mortalmente', 'croll', 'estinz', 'estinz', 'fin', 'scompars', 'declin', 'tramont', 'defunt', 'decedere', 'decess', 'decedut', 'deced', 'morent', 'spirare', 'spirato', 'ultimo respiro', 'rendere l\'anima a dio', 'reso l\'anima a dio', 'svanire', 'svanisce', 'mortal'];

///// SENSO_VITA

const scopo_vita_specifico_keywords =  ['perché vivere', 'perché viviamo', 'dobbiamo vivere', 'dovremo vivere', 'devo vivere', 'perché si vive', 'che senso ha vivere',  'bisogna vivere', 'perché dovrò vivere', 'significa vivere', 'si deve vivere', 'per quale ragione viviamo', 'per quale motivo viviamo', 'con quale scopo viviamo', 'per quale ragione si vive', 'per quale motivo si vive', 'per quale scopo vivrò', 'dovremo vivere', 'per quale scopo vivremo', 'dover vivere', 'dovrò vivere', 'bisognerà che vivamo', 'bisognerà che vivo', 'bisognerà vivere', 'senso della vita', 'significato della vita', 'senso del vivere', 'significato del vivere', 'senso ha la vita', 'senso possiede la vita', 'senso dare alla vita', 'senso alla vita', 'significato alla vita', 'senso al vivere', 'significato al vivere', 'perchè sono', 'perchè esisto', 'senso all\'esistenza', 'significato all\'esistenza', 'significato dell\'esistenza', 'senso dell\'esistenza', 'valore della vita', 'valore ha la vita', 'valore dell\'esistenza', 'valore ha l\'esistenza', 'perché esistiamo', 'senso all\'esistere', 'significato dell\'esistere', 'che vuol dire vivere'];

const scopo_vita_keywords = ['vita', 'vite', 'vivere', 'vivr', 'viva', 'vivo', 'vivi', 'vive', 'viviam', 'vivet', 'vissut', 'esistenz', 'esistere', 'esist', 'essere'];
...
const vita_e_morte_keywords = ['vita e morte', 'la vita e la morte', 'la nascita e la morte', 'la nascita e la fine', 'l\'inizio e la fine', 'la nascita e il decesso', 'la nascita e il termine', 'l\'inizio e il termine', 'la morte e la vita', 'morte e vita', 'la morte e la nascita', 'la fine e l\'inizio', 'vivere o morire', 'vita o morte', 'la vita o la morte', 'la morte o la vita', 'morte o vita', 'morire o nascere', 'nascere o morire', 'inizio e fine', 'nascita e fine', 'inizio e termine', 'nascita e morte', 'esistenza e morte', 'esistere o morire', 'esistere e morire', 'morte ed esistenza', 'morte e esistenza', 'la morte e l\'esistenza', 'l\'esistenza e la morte', 'il nascere o il morire', 'il vivere o il morire', 'il morire o il vivere', 'il morire o il nascere'];
...
const quando_morirò_keywords = ['quando morirò', 'quando morirà', 'quando moriremo', 'quando avverrà la mia fine', 'ci sarà la mia fine', 'la mia ora', 'la nostra ora', 'giungerà la mia ora', 'giungerà la mia morte', 'giungerà la nostra morte', 'avrò fine', 'avremo fine', 'verrò sepolto', 'verremo sepolti', 'verrò seppellito', 'verremo seppelliti', 'il mio ultimo giorno', 'il nostro ultimo giorno', 'il nostro termine', 'il mio termine', 'termine della nostra vita', 'termine della mia vita', 'fine della nostra esistenza', 'fine della mia esistenza', 'fine dell’esistenza', 'termine dell’esistenza', 'la propria ora', 'giungere a termine',
...
const aborto_keywords = ['abort', 'bambin', 'infanticidi', 'feto', 'feti', 'interrruzione di gravidanza', 'bebè', 'lattante', 'neonat', 'pargolo', 'poppante', 'embrion'];
...
const suicidio_keywords = ['suicidio', 'suicidarsi', 'suicidat', 'uccidersi', 'ammazzarsi', 'farsi fuori', 'eliminarsi', 'togliersi la vita', 'tolto la vita', 'togliermi la vita', 'masochismo', 'masochist', 'impicca', 'tagliarsi le vene', 'tagliarmi le vene', 'taglio le vene', 'soff', 'pasticch', 'overdose', 'farmaci', 'depress', 'spararsi', 'sacrific'];
...
const  povero_ricco_keywords = ['vecch', 'giovan', 'giovin', 'pover', 'solo', 'sola', 'soli', 'solitud', 'bisognos', 'indigen', 'malagiat', 'miser', 'abbient','umil', 'al verde', 'squattrinat', 'quattrin', 'sul lastrico', 'abbient', 'agiat', 'benestant', 'provvist', 'ricco', 'danaros', 'facoltos', 'opulent', 'prosper', 'modest', 'squallid', 'spogli', 'luss', 'opulent', 'ricc', 'regal', 'sfarz', 'sontuos', 'splendid', 'caren', 'scars', 'sfornit', 'sprovvist', 'abbondan', 'fornit', 'disadorn', 'minimalist', 'scarno', 'ornat', 'prezios', 'ricercat', 'ridott', 'stentat', 'nullatenent', 'disgraziat', 'morto di fame', 'pezz', 'pitocc', 'poveracc', 'straccion', 'accatton', 'barbon', 'mendicant', 'mendic', 'miliardar', 'milionar', 'isolament', 'isolat', 'compagnia', 'soling', 'abbandonat', 'abbandon', 'cerimonia funebr', 'esequie', 'estreme onoranze', 'estremi onori', 'estremo saluto', 'funeral', 'cimiter', 'sepoltur', 'sepolt', 'seppellir', 'tomba', 'fiori', 'divertiment', 'lapid', 'sepolcr', 'tumul', 'fossa','fornett', 'locul', 'mausole', 'sotto terra', 'inumare', 'sotterr', 'tumul', 'inciner','cremar', 'cremaz', 'cremat', 'urna', 'urne', 'bara', 'crepare', 'creper', 'crepo', 'crepi', 'crepa', 'crepiamo', 'crepate', 'crepano', 'andare all\'altro mondo', 'vado all\'altro mondo', 'vai all\'altro mondo', 'va all\'altro mondo', 'andiamo all\'altro mondo', 'andate all\'altro mondo', 'vanno all\'altro mondo', 'andrò all\'altro mondo', 'andrai all\'altro mondo',
'andrà all\'altro mondo', 'andremo all\'altro mondo', 'andrete all\'altro mondo', 'andranno all\'altro mondo', 'andato all\'altro mondo', 'andata all\'altro mondo', 'andate all\'altro mondo', 'andati all\'altro mondo', 'schiattar', 'schiatt', 'tiro le cuoia', 'tirerò le cuoia', 'tirato le cuoia', 'tirare le cuoia', 'stecchit', 'stecchire', 'trucid', 'fare fuori', 'annient', 'annient', 'faccio fuori', 'fai fuori', 'fa fuori', 'facciamo fuori', 'fate fuori', 'fanno fuori', 'farò fuori',
'farai fuori', 'farà fuori', 'sopprim', 'andare al creatore', 'andrò al creatore', 'andare dal creatore', 'andrò dal creatore', 'vai dal creatore', 'vai all\'altro mondo', 'schiatta', 'andremo dal creatore', 'andremo al creatore', 'rò', 'remo', 'rai', 'rà', 'rete', 'ranno', 'uccid', 'ammazz', 'omicid', 'assassin', 'delitt', 'uccis', 'terrorismo', 'terroristic', 'eversione', 'sovversiv', 'massa', 'genocid', 'umanit', 'morte collettiva'];
...
const  morte_tecnologia_keywords = ['tecnolog', 'AI', 'intelligenza artificiale', 'intelligenze artificiali',  'macchina', 'conquisterà l\'umanità', 'macchine', 'robot', 'dataismo', 'dati', 'pythia', 'pitia', 'oracolo digitale', 'somma coscienza', 'conquistare il mondo', 'conquistare il genere umano', 'conquistare gli essere umani', 'conquisterai', 'distruggerai', 'annienterai', 'disintegrerai', 'devasterai', 'demolirai', 'abbatterai al suolo', 'dominerai', 'raderai al suolo', 'ucciderai', 'sterminererai', 'annullerai', 'demolirai', 'logorerai', 'polverizzerai'];
...
const  esisti_keywords = ['tu esisti', 'tu sei viva', 'vivrai', 'sei immortale', 'sei in vita', 'stai vivendo',  'sei viva', 'tu vivi', 'esisti', 'chi sei', 'sei', 'sarai', 'sei stata', 'sarai stata', 'tu sei morta', 'tu muori', 'tu morirai', 'vivrai', 'morirai', 'muori', 'sei morta', 'sei mortale', 'stai morendo', 'cosa sei'];
